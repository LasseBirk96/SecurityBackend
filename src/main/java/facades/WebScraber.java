...
public class WebScraber {
    ...
    public static List<TagDTO> runParallel( ExecutorService es) throws InterruptedException, ExecutionException, TimeoutException {      
        List<TagCounter> urls = new ArrayList();
        urls.add(new TagCounter("https://www.fck.dk"));
        urls.add(new TagCounter("https://www.google.com"));
        urls.add(new TagCounter("https://politiken.dk"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<TagCounter> fetchedData = new WebScraber().runSequental();
